<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="ShowAllProducts.aspx.cs" Inherits="SpeedMaster.BO.ShowAllProducts" %>
                        ...
                        <asp:Repeater ID="Repeater3" runat="server" OnItemDataBound="Repeater1_ItemDataBound">
                            <ItemTemplate>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <%--este butao o icon esta um pouco desalinhado da um pouco de ocd, ja tentei alinhar mas nao estou a conseguir--%>
                                        <asp:LinkButton ID="LinkButton1" runat="server" class="btn btn-primary p-1 pb-2" Width="30px" Height="30px" CommandArgument=""><i class="fa-solid fa-eye"></i></asp:LinkButton>
                        ...
                        Width="30px" Height="30px" OnClick="btn_delete_Click" />--%>
                            ...
                            <AlternatingItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <asp:LinkButton ID="LinkButton1" runat="server" class="btn btn-primary p-1 me-2" Width="30px" Height="30px"><i class="fa-solid fa-eye"></i></asp:LinkButton>
                                        <%--<asp:ImageButton ID="btn_viewDetail" runat="server" class="btn btn-primary p-1 me-2" ImageUrl="~/BO/img/eye-solid.svg"
                        Width="30px" Height="30px" CommandArgument='<%# Eval("ProductID") %>' OnClick="btn_viewDetail_Click" />
                    <asp:ImageButton ID="btn_delete" runat="server" ImageUrl="~/BO/img/trash-can-solid.svg" class="btn btn-danger p-1"
                        Width="30px" Height="30px" OnClick="btn_delete_Click" />--%>
